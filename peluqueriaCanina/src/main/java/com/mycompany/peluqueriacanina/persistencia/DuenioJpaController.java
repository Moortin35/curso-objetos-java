...
public class DuenioJpaController implements Serializable {
    ...
    public void create(Duenio dueño) {
    ...
    public void edit(Duenio dueño) throws NonexistentEntityException, Exception {
        EntityManager em = null;
        try {
            em = getEntityManager();
            em.getTransaction().begin();
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            Duenio dueño;
            try {
                dueño = em.getReference(Duenio.class, id);
                dueño.getId();
    ...
    public List<Duenio> findDueñoEntities() {
        return findDueñoEntities(true, -1, -1);
    }

    public List<Duenio> findDueñoEntities(int maxResults, int firstResult) {
        return findDueñoEntities(false, maxResults, firstResult);
    }

    private List<Duenio> findDueñoEntities(boolean all, int maxResults, int firstResult) {
    ...
    public Duenio findDueño(int id) {
        EntityManager em = getEntityManager();
        try {
