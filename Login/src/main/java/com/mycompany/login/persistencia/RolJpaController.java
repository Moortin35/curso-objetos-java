    ...
    public void create(Rol rol) {
        ...
        try {
            ...
            for (Usuario listaUsuariosUsuario : rol.getListaUsuarios()) {
                Rol oldRolDeUsuarioOfListaUsuariosUsuario = listaUsuariosUsuario.getRolDeUsuario();
                listaUsuariosUsuario.setRolDeUsuario(rol);
                listaUsuariosUsuario = em.merge(listaUsuariosUsuario);
                if (oldRolDeUsuarioOfListaUsuariosUsuario != null) {
                    oldRolDeUsuarioOfListaUsuariosUsuario.getListaUsuarios().remove(listaUsuariosUsuario);
                    oldRolDeUsuarioOfListaUsuariosUsuario = em.merge(oldRolDeUsuarioOfListaUsuariosUsuario);
                }
            }
        ...
        try {
            ...
            for (Usuario listaUsuariosOldUsuario : listaUsuariosOld) {
                if (!listaUsuariosNew.contains(listaUsuariosOldUsuario)) {
                    listaUsuariosOldUsuario.setRolDeUsuario(null);
            ...
            for (Usuario listaUsuariosNewUsuario : listaUsuariosNew) {
                if (!listaUsuariosOld.contains(listaUsuariosNewUsuario)) {
                    Rol oldRolDeUsuarioOfListaUsuariosNewUsuario = listaUsuariosNewUsuario.getRolDeUsuario();
                    listaUsuariosNewUsuario.setRolDeUsuario(rol);
                    listaUsuariosNewUsuario = em.merge(listaUsuariosNewUsuario);
                    if (oldRolDeUsuarioOfListaUsuariosNewUsuario != null && !oldRolDeUsuarioOfListaUsuariosNewUsuario.equals(rol)) {
                        oldRolDeUsuarioOfListaUsuariosNewUsuario.getListaUsuarios().remove(listaUsuariosNewUsuario);
                        oldRolDeUsuarioOfListaUsuariosNewUsuario = em.merge(oldRolDeUsuarioOfListaUsuariosNewUsuario);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(int id) throws NonexistentEntityException {
        ...
        try {
            ...
            for (Usuario listaUsuariosUsuario : listaUsuarios) {
                listaUsuariosUsuario.setRolDeUsuario(null);
                listaUsuariosUsuario = em.merge(listaUsuariosUsuario);
            }
            em.remove(rol);
            em.getTransaction().commit();
