...
public class EditarUsuario extends javax.swing.JFrame {
    ...
    public EditarUsuario(ControladoraLogica controladoraLog, Usuario usr) {
    ...
    private void initComponents() {
        ...
        ttLogin.setText("Editar Usuarios");
        ...
        btnGuardarCambios.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        btnGuardarCambios.setText("Confirmar Cambios");
        ...
        if(!txtUsuario.getText().isEmpty()){
            if(!txtContrasenia.getText().isEmpty()){
                if(!itemSelected.isEmpty()){
                    ...
                    boolean noExiste = !corroborarExistenciaUsuario(nombreUsuario);
                    boolean esMiUser = usr.getNombreUsuario().equals(nombreUsuario);
                    
                    if(noExiste || esMiUser){
                        controladoraLog.editarUsuario(usr, nombreUsuario, contrasenia, rol);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        txtUsuario.setText(usr.getNombreUsuario());
        txtContrasenia.setText(usr.getContrasenia());
        String rolcito = usr.getRolDeUsuario().getNombreRol();
        //Seteo el rol en combo box
        int cantidadItems = cmbRol.getItemCount();
        for (int i = 0; i < cantidadItems; i++) {
            if (String.valueOf(cmbRol.getItemAt(i)).equals(rolcito)) {
